...
<html>
        ...
        <script type="text/javascript">
            function bloquearFormulario() {
                ...
                if (edadInput.value < 18) {
                    setTimeout(function() {
                        edadInput.readOnly = true;  // Desactivar el campo de edad
                        for (var i = 0; i < elementosFormulario.length; i++) {
                            elementosFormulario[i].disabled = true;  // Desactivar todos los elementos del formulario
                        }
                    }, 5000);  // 5000 ms = 5 segundos
                } else {
                    edadInput.readOnly = false;  // Habilitar el campo de edad
                    for (var i = 0; i < elementosFormulario.length; i++) {
                        elementosFormulario[i].disabled = false;  // Habilitar todos los elementos del formulario
                    }
                }
            }
        </script>
    ...
    ?>
        ...
        <form action="exget.php" method="get" id="miFormulario">
            ...
            Edat*: <input type="number" name="edat" id="edad" required value="<?php echo $edat; ?>" oninput="bloquearFormulario()"><br>
            ...
            <p>Comentaris:</p>
            <textarea id="w3review" name="comentaris" rows="10" cols="60"></textarea>
